...
void FOnJoyColorChangedEvent_DelegateWrapper(const FMulticastScriptDelegate& OnJoyColorChangedEvent, FLinearColor const& NewColor)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URamaColorPicker_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URamaColorPicker_SetJoyColor, "SetJoyColor" }, // 3409919814
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URamaColorPicker_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URamaColorPicker_Statics::NewProp_JoyColor = { "JoyColor", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URamaColorPicker, JoyColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URamaColorPicker_Statics::NewProp_JoyColor_MetaData), Z_Construct_UClass_URamaColorPicker_Statics::NewProp_JoyColor_MetaData) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_Sun5_PluginStaging_Output53_HostProject_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Sun5_PluginStaging_Output53_HostProject_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URamaColorPicker, URamaColorPicker::StaticClass, TEXT("URamaColorPicker"), &Z_Registration_Info_UClass_URamaColorPicker, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URamaColorPicker), 3044123304U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Sun5_PluginStaging_Output53_HostProject_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_2135672032(TEXT("/Script/VictoryBPLibrary"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Sun5_PluginStaging_Output53_HostProject_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Sun5_PluginStaging_Output53_HostProject_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
